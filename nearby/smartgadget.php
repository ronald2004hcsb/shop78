...
FROM smart_gadgets,shop
where shop.id=smart_gadgets.shop_id
HAVING distance < 20
ORDER BY distance");
}else{
	$res=mysqli_query($con,"select smart_gadgets.*,shop.shop_name from smart_gadgets,shop where shop.id=smart_gadgets.shop_id");
	  ...
	  function success(pos){
		  ...
		  jQuery.ajax({
			  ...
			  success:function(result){
				  window.location.href='smartgadget.php'
			  }
